...
def main():
    ...
    try:
        ...
        driver.find_element(By.XPATH, "//input[@name='persona_id']").send_keys("7942525")
        ...
        driver.find_element(By.XPATH, "//input[@name='telefono']").send_keys("62495843")
        driver.find_element(By.XPATH, "//input[@name='email']").send_keys("as@gmail.com")
        ...
        driver.find_element(By.XPATH, "//input[@name='numero_seguro']").send_keys("12456887")
        driver.find_element(By.XPATH, "//input[@name='foto']").send_keys(
            "D:\\descargas\\imagen.jpg")
